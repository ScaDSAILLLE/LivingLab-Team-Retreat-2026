...
- [`01-1000-welcome-framing`](01-1000-welcome-framing/) - framing, goals, roles, perspective exchange.
- [`02-1015-explore-nanobot`](02-1015-explore-nanobot/) - Nanobot WebUI and first success tasks.
- [`03-1030-nanobot-to-scaddy-v2`](03-1030-nanobot-to-scaddy-v2/) - Scaddy-V1 comparison and demonstrator scope.
- [`04-1045-ai-pair-programming-opencode`](04-1045-ai-pair-programming-opencode/) - opencode practice, prompt patterns, safe Git.
- [`05-1130-demo-spec-accessibility-cd`](05-1130-demo-spec-accessibility-cd/) - combined demo spec, accessibility, corporate design, UI implications.
- [`06-1230-baseline-stabilization`](06-1230-baseline-stabilization/) - repo, docs, setup, fallback, known limitations.
- [`07-1255-midday-check`](07-1255-midday-check/) - status before lunch.
- [`08-1400-reentry-plan`](08-1400-reentry-plan/) - afternoon planning and track selection.
- [`09-1410-feature-tracks`](09-1410-feature-tracks/) - knowledge, vision, voice, demo hardening.
- [`10-1455-deployment`](10-1455-deployment/) - deployment input, RPi/Nginx/Docker notes, operations questions.
- [`11-1520-repo-docs-finalization`](11-1520-repo-docs-finalization/) - final documentation and demo packaging.
- [`12-1545-demo-pitches`](12-1545-demo-pitches/) - pitch structure.
- [`13-1605-swot-closing`](13-1605-swot-closing/) - SWOT, Vision 2030, follow-up actions.
